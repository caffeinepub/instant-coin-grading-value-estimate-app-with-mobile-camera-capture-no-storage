...
export class Backend implements backendInterface {
    ...
    async configureBaseline(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.configureBaseline(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async processCoin(arg0: string, arg1: bigint, arg2: bigint, arg3: bigint): Promise<ProcessResult> {
        if (this.processError) {
            try {
                const result = await this.actor.processCoin(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
